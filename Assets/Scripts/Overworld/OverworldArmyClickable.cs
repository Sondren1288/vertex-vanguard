...
public class OverworldArmyClickable : MonoBehaviour
{
    ...
    private void OnMouseDown(){
        GameEvents.ArmyCubeSelected.Invoke(transform.position);
    }
    ...
    public void SetOwner(Ownership ownership){
        this.GetComponent<Renderer>().material.color = ownership == Ownership.Player ? Palette.Instance.playerColor : Palette.Instance.enemyColor;
    }
}
